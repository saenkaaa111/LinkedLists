...
namespace List.Tests
{
    class DoubleTests
    {
        ...
        {
            //act
            DoublyLinkedList linked = new DoublyLinkedList(array);
        ...
        public void AddFirst1Test(int[] array, int[] array2, int[] expected)
        {
            //act
            DoublyLinkedList linked = new DoublyLinkedList(array);
            DoublyLinkedList linked2 = new DoublyLinkedList(array2);
        ...
        public void AddAt1Test(int[] array, int[] array2, int idx, int[] expected)
        {
            //act
            DoublyLinkedList linked = new DoublyLinkedList(array);
            DoublyLinkedList linked2 = new DoublyLinkedList(array2);
        ...
        public void AddLast1Test(int[] array, int[] array2, int[] expected)
        {
            //act
            DoublyLinkedList linked = new DoublyLinkedList(array);
            DoublyLinkedList linked2 = new DoublyLinkedList(array2);
